...
<div>
      <button class="logout" style="margin-left:850px;">LOGOUT</button>
      <div style="margin: 85px;">
      <div style="background-color: rgb(245, 224, 175); width:200px; height: 80px; padding: 15px; margin-left:-50px; margin-top: 180px;"><img src="images/analytics-circle-green-512.webp" style="width: 50px; height:50px; margin-top:18px; "><h5 style=" margin-left:70px; margin-top:-40px;">Analysis</h5></div>
      ...
      <div style="background-color: rgb(245, 224, 175); width:200px; height: 80px; padding: 15px; margin-top: 100px; margin-left: -50px;"><img src="images/customers-icon-3.png " style="width: 50px; height:50px; margin-top:18px;"><h5 style=" margin-left:70px; margin-top:-40px;">Sales Rep</h5></div>
