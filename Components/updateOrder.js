...
export class updateorder extends HTMLElement {
    ...
    render(upreply) {
        ...
        <p style="margin-left: -110px; margin-top:10px"><a onClick="first()" style="cursor: pointer;">Home</a>/Customer/Update Order</p>
        <form style="background-color: rgb(255, 255, 255); width: 400px; margin-top: 45px; height: 550px; margin-left: 300px;">
            ...
            <input type="date" id="date" name="date" style="margin-left: 50px; width: 300px; border:none; border-bottom: 2px solid rgba(0, 0, 0, 0.39);" value="`+upreply[0].date+`" ><br>
            ...
            <p style="color: #ff3860; margin-left:20px; margin-top:1px" id="invalid"></p>
