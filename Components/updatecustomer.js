...
export class updatecustomer extends HTMLElement {
    ...
    render(upreply) {
        ...
        <p style="margin-left: -110px; margin-top:10px"><a onClick="first()" style="cursor: pointer;">Home</a>/Add Customer</p>
        <form style="background-color: rgb(255, 255, 255); width: 400px; margin-top: 45px; height: 500px; margin-left: 300px;">
            ...
            <input type="text" id="lname" name="lname" value="`+upreply[0].address+`"><br>
            
            <h5 for="category" style="margin-top: 20px; margin-left: 47px; color: rgba(0, 0, 0, 0.39);">Contact No</h5>
            
            <input type="text" id="cNo" name="lname" value="`+upreply[0].phone+`"><br>
